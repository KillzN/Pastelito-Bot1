...
const handler = async (m, { conn, args, usedPrefix }) => {
   ...
   const res = await fetch('https://www.instagram.com/ineffable.mvrco');
   ...
   txt += `${tradutor.texto1[11]}\n_${usedPrefix}Mi Instagram es : ${json?.html_url || 'https://www.instagram.com/ineffable.mvrco'}_`;
...
handler.command = ['scridawdawdpt', 'awdawdawd', 'readwawdawdawdapo']
