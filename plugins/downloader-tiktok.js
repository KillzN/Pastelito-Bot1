...
const handler = async (m, { conn, text, args, usedPrefix, command }) => {
  ...
  try {
    ...
    const prep = generateWAMessageFromContent(m.chat, { extendedTextMessage: { text: texto, contextInfo: { externalAdReply: { title: '🇰​​​​​🇮​​​​​🇱​​​​​🇱​​​​​ 🇧​​​​​🇴​​​​​🇹​​​​​', body: null, thumbnail: imagen1, sourceUrl: 'instagram.com/ineffable.mvrco' }, mentionedJid: [m.sender] } } }, aa);
    ...
    try {
      //const aa = {quoted: m, userJid: conn.user.jid};
      //const prep = generateWAMessageFromContent(m.chat, {extendedTextMessage: {text: texto, contextInfo: {externalAdReply: {title: '🇰​​​​​🇮​​​​​🇱​​​​​🇱​​​​​ 🇧​​​​​🇴​​​​​🇹​​​​​', body: null, thumbnail: imagen1, sourceUrl: 'https://github.com/BrunoSobrino/TheMystic-Bot-MD'}, mentionedJid: [m.sender]}}}, aa);
      //await conn.relayMessage(m.chat, prep.message, {messageId: prep.key.id, mentions: [m.sender]});
