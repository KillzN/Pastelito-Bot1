...
/* Creditos a Otosaka (https://wa.me/56952541249) */
...
const connectionOptions = {
  ...
  mobile: MethodMobile,
  browser: opcion === '1' ? ['@𝖎𝖓𝖊𝖋𝖋𝖆𝖇𝖑𝖊.𝖒𝖛𝖗𝖈𝖔', 'KɪʟʟᴢN', '2.0.0'] : methodCodeQR ? ['@𝖎𝖓𝖊𝖋𝖋𝖆𝖇𝖑𝖊.𝖒𝖛𝖗𝖈𝖔', 'KɪʟʟᴢN', '2.0.0'] : ['Ubuntu', 'Chrome', '20.0.04'],
  auth: {
    creds: state.creds,
...
setInterval(async () => {
  ...
  const bio = `• Activo: ${uptime} | KɪʟʟᴢN - @𝖎𝖓𝖊𝖋𝖋𝖆𝖇𝖑𝖊.𝖒𝖛𝖗𝖈𝖔`;
